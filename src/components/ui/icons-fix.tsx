...
// All icons are self-contained to prevent HMR issues

import React from 'react';

// Self-contained icon implementations to prevent HMR issues
...
// Inline fallback for Image icon (avoid importing from lucide-react to prevent HMR issues)
...
// Export ImageIcon as an alias for Image to fix import issues
...
// Wifi icons (added for compatibility)
...
export const WifiOff = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="24"
    height="24"
  ...
  >
    ...
    <path d="M5.1 12.2a10 10 0 0 1 13.8 0" />
    <path d="M8.53 15.11a6 6 0 0 1 6.95 0" />
    <line x1="2" y1="2" x2="22" y2="22" />
    <circle cx="12" cy="20" r="1" />
  </svg>
...
// Stable HelpCircle icon to avoid lucide-react HMR chunk issues
