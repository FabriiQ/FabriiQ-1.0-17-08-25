      ...
      if (activityData.length === 0) {
        ...
        return {
          ...
          learningStyle: {
            ...
            confidence: 0,
            indicators: ['No activity data available']
          },
          cognitivePreferences: {
          ...
          riskFactors: [{
            ...
            recommendations: ['Encourage student to complete more activities', 'Provide initial assessment activities']
          }],
          strengths: [],
          adaptiveRecommendations: [{
            type: 'content_delivery',
            priority: 'medium' as const,
            recommendation: 'Start with basic assessment activities to establish learning patterns',
            rationale: 'Insufficient data for personalized recommendations'
          }]
        };
      }
